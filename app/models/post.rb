class Post < ActiveRecord::Base
  ...
  def self.popular
    Post.joins(:statistics)
        ...
        .group('posts.id, posts.title, posts.path, posts.user_id, posts.published_at, posts.comment_count, posts.wordpress_id, posts.tweet_count, users.name, users.email')
